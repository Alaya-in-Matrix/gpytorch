...
class _Likelihood(Module, ABC, _ClassWithDeprecatedBatchSize):
    ...
    def marginal(self, function_dist, *args, **kwargs):
        return self._draw_likelihood_samples(function_dist, *args, **kwargs)
    ...
    class Likelihood(_Likelihood):
        ...
        def marginal(self, function_dist, *args, **kwargs):
            ...
            with pyro.plate(plate_name, size=num_samples, dim=(-self.max_plate_nesting - 1)):
                ...
                return pyro.poutine.replay(marginal_fn, trace=guide_trace)(*args, **kwargs)
        ...
        def pyro_sample_output(self, observations, function_dist, *params, **kwargs):
            ...
            """
            warnings.warn(
                "Likelihood.pyro_sample_output is deprecated. Make sure that your likelihood has properly "
                "implemented a `forward` function.", DeprecationWarning
            )
            name_prefix = kwargs.get("name_prefix", "")
